...
/**
 * Util class of constants used in this project.
 *
...
public final class Constants {
   ...
   * so that it can be used for reverse geocoding.
   ...
   */
  public static final List<String> CONSOLIDATED_STATE_CODES = Lists.newArrayList(
    "AL", "AK", "AZ", "AR", "CA", "CO", "CT", "DE", "DC", "FL", "GA", "HI", "ID", "IL", "IN", "IA", "KS", "KY", "LA", 
    "ME", "MT", "NE", "NV", "NH", "NJ", "NM", "NY", "NC", "ND", "OH", "OK", "OR", "MD", "MA", "MI", "MN", "MS", "MO", 
    "PA", "RI", "SC", "SD", "TN", "TX", "UT", "VT", "VA", "WA", "WV", "WI", "WY");

  /**
   * Map that associates the full name with the code name of each State
   */
  ...
  /**
   * Map that associates a unique id with each State
   */
