...
public final class BingMapsLookup {
   ...
   */
  public static final Optional<String> reverseGeocodeFromLatLong(final double latitude, final double longitude) {
  ...
  private static final Optional<String> getStateFromJSONResponse(InputStream inputStream) {
